...
// node_modules/out-of-character/builds/out-of-character.js
var require_out_of_character = __commonJS({
  "node_modules/out-of-character/builds/out-of-character.js"(exports, module2) {
    (function(global, factory) {
      typeof exports === "object" && typeof module2 !== "undefined" ? module2.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.outOfCharacter = factory());
    })(exports, function() {
      "use strict";
      var require$$0 = [
        {
      ...
      var isEmoji$1 = function isEmoji2(text, i) {
        if (text[i - 1]) {
      ...
      var findAll$1 = function findAll2(text) {
...
var Calibre = class {
  ...
  init() {
    const sourcedb = import_path.default.join(this.dir, "metadata.db");
    if (!(0, import_fs.existsSync)(sourcedb)) {
      console.error("Quitting: no database found at", sourcedb);
      process.exit(1);
    }
    try {
      this.db = new import_better_sqlite3.default(sourcedb, { readonly: true });
    } catch (err) {
      console.log(err);
    }
  }
...
var DEFAULT_USER_UID = import_node_os2.default.userInfo().uid;
var DEFAULT_USER_GID = import_node_os2.default.userInfo().gid;
...
var Covers = class {
  ...
  writeCover = async (book) => {
    try {
      if (Number.isInteger(book.id) && !(0, import_fs2.existsSync)(import_path2.default.join(this.coversDir, `${book.id}.webp`))) {
        await (0, import_sharp.default)(import_path2.default.join(this.calibreDir, book.path, "cover.jpg")).resize(100).toFormat("webp").toFile(import_path2.default.join(this.coversDir, `${book.id}.webp`));
      } else {
...
var import_out_of_character = __toESM(require_out_of_character(), 1);
var Metadata = class {
  datafile;
  #file;
  #data;
  ...
  constructor(datafile) {
    ...
    this.#file = (0, import_fs3.readFileSync)(this.datafile, "utf-8");
  ...
  write() {
    try {
      (0, import_fs3.writeFileSync)(this.datafile, import_out_of_character.default.replace(JSON.stringify(this.#data, null, 2)), "utf-8");
    } catch (error) {
      console.error(error);
    }
  }
...
var metadata = new Metadata(config.get("datafile"));
var db = new Calibre(config.get("calibreDir"));
db.init();

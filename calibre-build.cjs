...
function splitLine(result, lineStr) {
  ...
  function data(index, workingDir, path7) {
    ...
    if (raw !== "##" && raw !== "!!") {
      result.files.push(new FileStatusSummary(path7.replace(/\0.+$/, ""), index, workingDir));
    }
  }
}
var StatusSummary;
  ...
  "src/lib/simple-git-api.ts"() {
    ...
    SimpleGitApi = class {
      ...
      hashObject(path7, write) {
        return this._runTask(hashObjectTask(path7, write === true), trailingFunctionArgument(arguments));
      }
      init(bare) {
...
var FS = {
  attempt: {
    ...
    close: attemptifyAsync((0, import_node_util.promisify)(import_node_fs.default.close), NOOP2),
    fsync: attemptifyAsync((0, import_node_util.promisify)(import_node_fs.default.fsync), NOOP2),
    mkdir: attemptifyAsync((0, import_node_util.promisify)(import_node_fs.default.mkdir), NOOP2),
    realpath: attemptifyAsync((0, import_node_util.promisify)(import_node_fs.default.realpath), NOOP2),
    stat: attemptifyAsync((0, import_node_util.promisify)(import_node_fs.default.stat), NOOP2),
    unlink: attemptifyAsync((0, import_node_util.promisify)(import_node_fs.default.unlink), NOOP2),
    /* SYNC */
    ...
    closeSync: attemptifySync(import_node_fs.default.closeSync, NOOP2),
    existsSync: attemptifySync(import_node_fs.default.existsSync, NOOP2),
    fsyncSync: attemptifySync(import_node_fs.default.fsync, NOOP2),
    mkdirSync: attemptifySync(import_node_fs.default.mkdirSync, NOOP2),
    realpathSync: attemptifySync(import_node_fs.default.realpathSync, NOOP2),
    statSync: attemptifySync(import_node_fs.default.statSync, NOOP2),
    unlinkSync: attemptifySync(import_node_fs.default.unlinkSync, NOOP2)
  },
  retry: {
    /* ASYNC */
...
function isUint8Array(value) {
  return value && objectToString2.call(value) === "[object Uint8Array]";
}
...
var Covers = class {
  constructor(coversDir2, calibreDir2) {
    this.coversDir = coversDir2;
    this.calibreDir = calibreDir2;
  }
...
var dataFile = config.get("datafile");
var calibreDir = config.get("calibreDir");
var coversDir = config.get("coversDir");
var metadata = new Metadata(dataFile);
var db = new Calibre(calibreDir);
db.init();
var updateMetadata = async () => {
  ...
  metadata.data.lastUpdate = /* @__PURE__ */ new Date();
  metadata.write();
